...
- Failed at: 2026-04-23T13:44:44-04:00
- Retries attempted: 2
...
### Process Flow for Reference Document Scan — PF2E Guns and Gears
...
- **File**: `org-chart/agents/instructions/ba-dungeoncrawler.instructions.md`
- **Verification Method**: Review the updated instructions for accuracy and completeness.

#### 1) Read the current work request
- **Action**: Identify the user goal, cons
