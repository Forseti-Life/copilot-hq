...
- Failed at: 2026-04-23T17:25:07-04:00
- Retries attempted: 2
...
Based on the provided context and instructions, here's a step-by-step guide to activate features for the release `20260412-dungeoncrawler-release-n`:

### Step 1: Review Ready Features
First, review the list of ready features and prioritize them based on their importance and impact. The ready features are:
- `dc-b2-bestiary2`
- `dc-gng-guns-gears`
...
Activate at least 3 of the highest-pr
