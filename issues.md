...
## Release Efficiency Findings — 20260412-forseti-release-q — 2026-05-04

> **Source:** `scripts/release-efficiency-analysis.py` — automated analysis.
> 3 FAIL finding(s) detected. See below for details.

### ISSUE-005 — Gate R5 delay: 6.2h post-push (threshold: 4h)

**Severity:** High
**Release:** 20260412-forseti-release-q
**Source:** release-efficiency-analysis.py

**Finding:** Gate R5 delay: 6.2h post-push (threshold: 4h)

**Status:** 🔴 Open — review and assign fix

### ISSUE-006 — Gating agent(s) majority-quarantined: agent-code-review (1/1 = 100%),

**Severity:** High
**Release:** 20260412-forseti-release-q
**Source:** release-efficiency-analysis.py

**Finding:** Gating agent(s) majority-quarantined: agent-code-review (1/1 = 100%), pm-dungeoncrawler (2/2 = 100%) — release gates bypassed by executor failure

**Status:** 🔴 Open — review and assign fix

### ISSUE-007 — Code review gate: 1 session(s) dispatched but all are quarantined/need
...
## Release Efficiency Findings — 20260412-forseti-release-r — 2026-05-04

> **Source:** `scripts/release-efficiency-analysis.py` — automated analysis.
> 1 FAIL finding(s) detected. See below for details.

### ISSUE-008 — Gating agent(s) majority-quarantined: pm-forseti (5/7 = 71%) — release

**Severity:** High
**Release:** 20260412-forseti-release-r
**Source:** release-efficiency-analysis.py

**Finding:** Gating agent(s) majority-quarantined: pm-forseti (5/7 = 71%) — release gates bypassed by executor failure
...
## Release Efficiency Findings — 20260412-forseti-release-s — 2026-05-05
...
## Release Efficiency Findings — 20260412-dungeoncrawler-release-v — 2026-05-05

> **Source:** `scripts/release-efficiency-analysis.py` — automated analysis.
> 2 FAIL finding(s) detected. See below for details.

### ISSUE-017 — Gating agent(s) majority-quarantined: agent-code-review (1/1 = 100%) —
...
### ISSUE-018 — Code review gate: 1 session(s) dispatched but all are quarantined/need
