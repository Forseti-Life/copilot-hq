...
## Release Efficiency Findings — 20260412-forseti-release-v — 2026-04-27

> **Source:** `scripts/release-efficiency-analysis.py` — automated analysis.
> 1 FAIL finding(s) detected. See below for details.

### ISSUE-013 — Gating agent(s) majority-quarantined: pm-forseti (1/1 = 100%) — releas
...
## Release Efficiency Findings — 20260412-dungeoncrawler-release-x — 2026-04-27

> **Source:** `scripts/release-efficiency-analysis.py` — automated analysis.
> 1 FAIL finding(s) detected. See below for details.

### ISSUE-014 — CEO proxy load: 8 sessions doing dev/QA/PM work (dev=3, QA=4, PM=1) —

**Severity:** High
**Release:** 20260412-dungeoncrawler-release-x
**Source:** release-efficiency-analysis.py

**Finding:** CEO proxy load: 8 sessions doing dev/QA/PM work (dev=3, QA=4, PM=1) — executor broken or roles understaffed
...
## Release Efficiency Findings — 20260412-dungeoncrawler-release-ab — 2026-05-02

> **Source:** `scripts/release-efficiency-analysis.py` — automated analysis.
> 1 FAIL finding(s) detected. See below for details.

### ISSUE-019 — Gating agent(s) majority-quarantined: pm-dungeoncrawler (1/2 = 50%) —

**Severity:** High
**Release:** 20260412-dungeoncrawler-release-ab
**Source:** release-efficiency-analysis.py

**Finding:** Gating agent(s) majority-quarantined: pm-dungeoncrawler (1/2 = 50%) — release gates bypassed by executor failure
