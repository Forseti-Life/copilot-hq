  ...
  const CATALOG = [
    ...
    'cognitive-mutagen' => [
      ...
      'alchemical_stats' => [
        ...
        'traits'            => ['alchemical', 'consumable', 'elixir', 'mutagen'],
        'description'       => 'Grants +2 status bonus to Intelligence checks and DCs, but takes -1 status penalty to Wisdom-based checks (10 rounds). Self-use only.',
      ],
    ],
    'quicksilver-mutagen' => [
      ...
      'alchemical_stats' => [
        ...
        'traits'            => ['alchemical', 'consumable', 'elixir', 'mutagen'],
        'description'       => 'Grants +2 status bonus to Dexterity checks and AC, but takes -1 status penalty to Strength-based checks (10 rounds). Self-use only.',
      ],
    ],
    'hulking-mutagen' => [
      'id'       => 'hulking-mutagen',
      'name'     => 'Hulking Mutagen',
      'type'     => 'alchemical',
      'source_book' => 'crb',
      'price_gp' => 2,
      'bulk'     => 'L',
      'alchemical_stats' => [
        ...
        'traits'            => ['alchemical', 'consumable', 'elixir', 'mutagen'],
        'description'       => 'Grants +2 status bonus to Strength-based checks and melee damage, but takes -1 status penalty to Dexterity-based checks and AC (10 rounds). Self-use only.',
      ],
    ],
    'alchemical-primer' => [
      'id'       => 'alchemical-primer',
      ...
      'alchemical_stats' => [
        'subtype'           => 'tool',
        'consumable'        => FALSE,
        'is_alchemical_tool' => TRUE,
        'traits'            => ['alchemical', 'tool'],
        'description'       => 'A reference guide for alchemical formulas. Grants +1 circumstance bonus to Crafting checks for alchemical items (when using Alchemy Lore).',
      ],
    ],
