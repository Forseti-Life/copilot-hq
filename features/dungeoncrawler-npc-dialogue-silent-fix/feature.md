# Feature Brief: On campaign page reload, the player's current room resets to the starting location (The Gilded Ta...

- Work item id: dungeoncrawler-npc-dialogue-silent-fix
...
- Source: community_suggestion NID 52 (Talk to Forseti intake)
- Category: Technical Improvement
- Created: 2026-05-03

## Goal

On campaign page reload, the player's current room resets to the starting location (The Gilded Tankard) instead of restoring their last saved position. This causes loss of navigation state and breaks campaign continuity.
...
> Suggestion summary: On campaign page reload, the player's current room resets to the starting location (The Gilded Tankard) instead of restoring their last saved position. This causes loss of navigation state and breaks campaign continuity.
Suggestion category: technical_improvement
Original player request:
When I am reloading the page for the campaign. it seems to reset back to the Gilded tankard tavern. seems like a defect.
...
Recent conversation reference (last 37 lines, max 150):
...
- 2026-05-03: Created from community_suggestion NID 52 via suggestion-triage.sh
