...
- Dispatched-at: 2026-04-24T16:50:06Z
...
Agent `qa-infra` has latest outbox `20260424-verify-dev-item-prep-drupal-ai-extraction.md` with status `needs-info`, but no supervisor escalation item exists.
