# Release support required: dc-cr-languages

- Agent: dev-dungeoncrawler
- Feature: dc-cr-languages
- Release: 20260412-dungeoncrawler-release-y
- Status: pending
- Created: 2026-04-28T13:51:32+00:00
...
## Action required
1. Review feature brief: `features/dc-cr-languages/feature.md`
2. Review acceptance criteria: `features/dc-cr-languages/01-acceptance-criteria.md`
3. Confirm the existing implementation/commit hashes that should ship in release `20260412-dungeoncrawler-release-y`
