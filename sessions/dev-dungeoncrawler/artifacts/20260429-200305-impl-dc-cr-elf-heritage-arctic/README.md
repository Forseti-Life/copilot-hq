# Implementation required: dc-cr-elf-heritage-arctic
...
## Action required
1. Review feature brief: `features/dc-cr-elf-heritage-arctic/feature.md`
2. Review acceptance criteria: `features/dc-cr-elf-heritage-arctic/01-acceptance-criteria.md`
