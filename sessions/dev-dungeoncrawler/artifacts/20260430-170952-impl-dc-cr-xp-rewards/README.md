# Implementation required: dc-cr-xp-rewards
...
- Flow-managed SDLC run: `agentic_sdlc / dc-cr-xp-rewards`

## Action required
1. Review feature brief: `features/dc-cr-xp-rewards/feature.md`
2. Review acceptance criteria: `features/dc-cr-xp-rewards/01-acceptance-criteria.md`
