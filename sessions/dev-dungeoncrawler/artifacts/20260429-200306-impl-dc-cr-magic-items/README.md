# Implementation required: dc-cr-magic-items
...
## Action required
1. Review feature brief: `features/dc-cr-magic-items/feature.md`
2. Review acceptance criteria: `features/dc-cr-magic-items/01-acceptance-criteria.md`
