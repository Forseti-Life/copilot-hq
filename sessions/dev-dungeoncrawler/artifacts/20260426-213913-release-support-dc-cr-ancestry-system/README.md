# Release support required: dc-cr-ancestry-system
...
## Action required
1. Review feature brief: `features/dc-cr-ancestry-system/feature.md`
2. Review acceptance criteria: `features/dc-cr-ancestry-system/01-acceptance-criteria.md`
