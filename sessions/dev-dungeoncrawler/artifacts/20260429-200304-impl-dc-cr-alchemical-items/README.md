# Implementation required: dc-cr-alchemical-items
...
## Action required
1. Review feature brief: `features/dc-cr-alchemical-items/feature.md`
2. Review acceptance criteria: `features/dc-cr-alchemical-items/01-acceptance-criteria.md`
