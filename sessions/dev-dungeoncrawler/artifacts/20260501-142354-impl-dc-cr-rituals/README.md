# Implementation required: dc-cr-rituals

- Agent: dev-dungeoncrawler
- Feature: dc-cr-rituals
- Release: 20260412-dungeoncrawler-release-aa
- Status: pending
- Created: 2026-05-01T14:23:54+00:00
...
- Flow-managed SDLC run: `agentic_sdlc / dc-cr-rituals`

## Action required
1. Review feature brief: `features/dc-cr-rituals/feature.md`
2. Review acceptance criteria: `features/dc-cr-rituals/01-acceptance-criteria.md`
3. Implement the feature for release `20260412-dungeoncrawler-release-aa`
