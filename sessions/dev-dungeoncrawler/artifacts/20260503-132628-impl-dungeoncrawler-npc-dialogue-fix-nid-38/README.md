# Implementation required: dungeoncrawler-npc-dialogue-fix-nid-38

- Agent: dev-dungeoncrawler
- Feature: dungeoncrawler-npc-dialogue-fix-nid-38
...
- Flow-managed SDLC run: `agentic_sdlc / dungeoncrawler-npc-dialogue-fix-nid-38`

## Action required
1. Review feature brief: `features/dungeoncrawler-npc-dialogue-fix-nid-38/feature.md`
2. Review acceptance criteria: `features/dungeoncrawler-npc-dialogue-fix-nid-38/01-acceptance-criteria.md`
