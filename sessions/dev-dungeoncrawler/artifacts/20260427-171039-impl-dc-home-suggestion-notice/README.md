...
## Action required
1. Review `features/dc-home-suggestion-notice/feature.md`
2. Review `features/dc-home-suggestion-notice/01-acceptance-criteria.md`
3. Review `features/dc-home-suggestion-notice/03-test-plan.md`
...
## Acceptance criteria
- A dev outbox artifact exists for dc-home-suggestion-notice
