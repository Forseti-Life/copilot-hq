...
- Flow source outbox: sessions/agent-code-review/outbox/20260503-flow-agentic_sdlc-dc-gm-auto-bug-report-code-review-r1.md
- Flow owner binding: product_team.dev_agent
- Product team id: dungeoncrawler
- Product team label: Dungeoncrawler
- Flow incoming conditions: Changes requested
...
2. Review the source outbox: `sessions/agent-code-review/outbox/20260503-flow-agentic_sdlc-dc-gm-auto-bug-report-code-review-r1.md` for the completed upstream context.
