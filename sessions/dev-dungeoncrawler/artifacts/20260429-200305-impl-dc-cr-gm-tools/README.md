# Implementation required: dc-cr-gm-tools
...
## Action required
1. Review feature brief: `features/dc-cr-gm-tools/feature.md`
2. Review acceptance criteria: `features/dc-cr-gm-tools/01-acceptance-criteria.md`
