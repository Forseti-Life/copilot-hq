...
## Action required
1. Review `features/dc-cr-xp-award-system/feature.md`
2. Review `features/dc-cr-xp-award-system/01-acceptance-criteria.md`
3. Review `features/dc-cr-xp-award-system/03-test-plan.md`
...
## Acceptance criteria
- A dev outbox artifact exists for dc-cr-xp-award-system
