# Implementation required: dc-cr-xp-award-system
...
## Action required
1. Review feature brief: `features/dc-cr-xp-award-system/feature.md`
2. Review acceptance criteria: `features/dc-cr-xp-award-system/01-acceptance-criteria.md`
