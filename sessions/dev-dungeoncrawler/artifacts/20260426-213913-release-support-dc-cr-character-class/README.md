# Release support required: dc-cr-character-class
...
## Action required
1. Review feature brief: `features/dc-cr-character-class/feature.md`
2. Review acceptance criteria: `features/dc-cr-character-class/01-acceptance-criteria.md`
