# Release support required: dc-cr-halfling-ancestry
...
## Action required
1. Review feature brief: `features/dc-cr-halfling-ancestry/feature.md`
2. Review acceptance criteria: `features/dc-cr-halfling-ancestry/01-acceptance-criteria.md`
