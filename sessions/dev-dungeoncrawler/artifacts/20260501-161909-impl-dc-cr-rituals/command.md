- Status: done
- Completed: 2026-05-01T16:19:33Z
...
This feature has been activated into release `20260412-dungeoncrawler-release-aa` and now enters the implementation lane of the SDLC flow.
...
## Required action
1. Review `features/dc-cr-rituals/feature.md`, `features/dc-cr-rituals/01-acceptance-criteria.md`, and `features/dc-cr-rituals/03-test-plan.md`.
