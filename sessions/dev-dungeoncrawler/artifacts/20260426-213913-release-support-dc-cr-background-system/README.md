# Release support required: dc-cr-background-system
...
## Action required
1. Review feature brief: `features/dc-cr-background-system/feature.md`
2. Review acceptance criteria: `features/dc-cr-background-system/01-acceptance-criteria.md`
