- Status: done
- Completed: 2026-04-30T17:13:28Z
...
## Required action
1. Review `features/dc-cr-rock-runner/feature.md`, `features/dc-cr-rock-runner/01-acceptance-criteria.md`, and `features/dc-cr-rock-runner/03-test-plan.md`.
