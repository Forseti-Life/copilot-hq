# Implementation required: dc-cr-rock-runner
...
- Flow-managed SDLC run: `agentic_sdlc / dc-cr-rock-runner`

## Action required
1. Review feature brief: `features/dc-cr-rock-runner/feature.md`
2. Review acceptance criteria: `features/dc-cr-rock-runner/01-acceptance-criteria.md`
