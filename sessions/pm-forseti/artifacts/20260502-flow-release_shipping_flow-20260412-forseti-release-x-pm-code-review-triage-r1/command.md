...
- Flow source outbox: sessions/agent-code-review/outbox/20260502-code-review-forseti.life-20260412-forseti-release-x.md
- Flow owner binding: product_team.pm_agent
- Product team id: forseti
- Product team label: Forseti
- Flow incoming conditions: MEDIUM+ findings present
...
2. Review the source outbox: `sessions/agent-code-review/outbox/20260502-code-review-forseti.life-20260412-forseti-release-x.md` for the completed upstream context.
