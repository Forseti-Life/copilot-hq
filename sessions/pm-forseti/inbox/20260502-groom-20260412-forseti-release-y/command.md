...
- Site: forseti.life
- Current release (Dev executing): 20260412-forseti-release-x
- Next release (your target): 20260412-forseti-release-y
...
- **Next release** — You groom the backlog so Stage 0 of 20260412-forseti-release-y is instant scope selection.

This task does NOT touch the current release. All work here is for 20260412-forseti-release-y only.
...
For each feature selected into 20260412-forseti-release-y:
```bash
...
Anything not groomed when Stage 0 of 20260412-forseti-release-y starts is automatically deferred.
