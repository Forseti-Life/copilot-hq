- command: |
    ...
    Your last outbox for item 20260503-release-kpi-stagnation was escalated up-chain, but it is missing required context.
    ...
    Reference:
    - Original outbox: sessions/pm-forseti/outbox/20260503-release-kpi-stagnation.md
