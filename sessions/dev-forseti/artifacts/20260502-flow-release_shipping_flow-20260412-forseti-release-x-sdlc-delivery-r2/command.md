...
- Flow run id: 20260412-forseti-release-x
- Flow node: SDLC Delivery
- Flow owner seat: dev-forseti
- Flow previous node: PM Code Review Triage
- Flow source outbox: sessions/pm-forseti/outbox/20260502-flow-release_shipping_flow-20260412-forseti-release-x-pm-code-review-triage-r2.md
...
This inbox item was routed automatically from `PM Code Review Triage` after `pm-forseti` completed the previous step.

## Required action
1. Execute the responsibilities of `SDLC Delivery` as the owning seat `dev-forseti`.
2. Review the source outbox: `sessions/pm-forseti/outbox/20260502-flow-release_shipping_flow-20260412-forseti-release-x-pm-code-review-triage-r2.md` for the completed upstream context.
