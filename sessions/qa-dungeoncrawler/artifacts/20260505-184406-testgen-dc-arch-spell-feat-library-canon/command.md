# Test Plan Design: dc-arch-spell-feat-library-canon

**From:** pm-dungeoncrawler  
**To:** qa-dungeoncrawler  
**Date:** 2026-05-05T18:44:06+00:00  
...
`qa-suites/products/dungeoncrawler/features/dc-arch-spell-feat-library-canon.json`
...
1. **Create** `features/dc-arch-spell-feat-library-canon/03-test-plan.md` — the test spec:
   - List every test case derived from the AC
   - For each: test description, which suite it will live in, expected HTTP status or behavior, roles covered
   - Flag any AC items that cannot be expressed as automation (note to PM)
2. **Create** `qa-suites/products/dungeoncrawler/features/dc-arch-spell-feat-library-canon.json` from `templates/qa-feature-suite.json`:
   ...
   - Point `test_plan` at `features/dc-arch-spell-feat-library-canon/03-test-plan.md`
   - Validate with:
     ```bash
     python3 scripts/qa-suite-validate.py --product dungeoncrawler --feature-id dc-arch-spell-feat-library-canon
     ```
2. **Signal completion:**
    ```bash
    ./scripts/qa-pm-testgen-complete.sh dungeoncrawler dc-arch-spell-feat-library-canon "<brief summary>"
   ```
