...
- Flow source outbox: sessions/pm-dungeoncrawler/outbox/20260503-flow-agentic_sdlc-dungeoncrawler-suggestion-nid-45-pm-scope-rebaseline-r1.md
...
2. Review the source outbox: `sessions/pm-dungeoncrawler/outbox/20260503-flow-agentic_sdlc-dungeoncrawler-suggestion-nid-45-pm-scope-rebaseline-r1.md` for the completed upstream context.
...
- If `features/dungeoncrawler-suggestion-nid-45/03-test-plan.md` and `qa-suites/products/dungeoncrawler/features/dungeoncrawler-suggestion-nid-45.json` already exist and still match the current feature scope, fast-exit with `- Status: done` and cite those exact paths instead of regenerating them.
...
## Required artifacts
- Write or update `sessions/qa-dungeoncrawler/artifacts/dungeoncrawler-suggestion-nid-45-test-plan.md` with the concrete test plan for this feature.
- Write or update `qa-suites/products/dungeoncrawler/features/dungeoncrawler-suggestion-nid-45.json` with the feature-level suite overlay or equivalent QA coverage metadata.
