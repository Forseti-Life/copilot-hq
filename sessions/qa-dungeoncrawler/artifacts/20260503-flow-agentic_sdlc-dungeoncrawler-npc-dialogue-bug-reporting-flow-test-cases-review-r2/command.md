...
- Flow source outbox: sessions/qa-dungeoncrawler/outbox/20260503-flow-agentic_sdlc-dungeoncrawler-npc-dialogue-bug-reporting-flow-write-test-cases-r1.md
...
2. Review the source outbox: `sessions/qa-dungeoncrawler/outbox/20260503-flow-agentic_sdlc-dungeoncrawler-npc-dialogue-bug-reporting-flow-write-test-cases-r1.md` for the completed upstream context.
