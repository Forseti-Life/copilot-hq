...
- Flow source outbox: sessions/pm-dungeoncrawler/outbox/20260430-flow-agentic_sdlc-dc-cr-rock-runner-pm-scope-rebaseline-r1.md
...
2. Review the source outbox: `sessions/pm-dungeoncrawler/outbox/20260430-flow-agentic_sdlc-dc-cr-rock-runner-pm-scope-rebaseline-r1.md` for the completed upstream context.
...
## Required artifacts
- Write or update `sessions/qa-dungeoncrawler/artifacts/dc-cr-rock-runner-test-plan.md` with the concrete test plan for this feature.
- Write or update `qa-suites/products/dungeoncrawler/features/dc-cr-rock-runner.json` with the feature-level suite overlay or equivalent QA coverage metadata.
