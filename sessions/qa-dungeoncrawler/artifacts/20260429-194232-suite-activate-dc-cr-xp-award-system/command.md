- Status: done
- Completed: 2026-04-29T19:46:53Z

# Suite Activation: dc-cr-xp-award-system

**From:** pm-dungeoncrawler  
**To:** qa-dungeoncrawler  
**Date:** 2026-04-29T19:42:32+00:00  
...
1. **Add a suite entry to** `qa-suites/products/dungeoncrawler/suite.json`  
   ...
   **CRITICAL: tag every new entry with `"feature_id": "dc-cr-xp-award-system"`**  
   This links the test to the living requirements doc at `features/dc-cr-xp-award-system/`.  
   Dev reads this field to know: failing test = new feature to implement, not a regression.  
   Minimum suite entry structure:
   ```json
   {
     "id": "dc-cr-xp-award-system-e2e",
     "label": "<describe what the test verifies>",
     "type": "e2e",
     "feature_id": "dc-cr-xp-award-system",
...
2. **Add permission rules to** `org-chart/sites/dungeoncrawler.life/qa-permissions.json`  
   ...
   **CRITICAL: tag every new rule with `"feature_id": "dc-cr-xp-award-system"`**  
   Example:
   ```json
   {
     "id": "dc-cr-xp-award-system-<route-slug>",
     "feature_id": "dc-cr-xp-award-system",
     "path_regex": "/your-new-route",
     "notes": "Added for feature dc-cr-xp-award-system",
