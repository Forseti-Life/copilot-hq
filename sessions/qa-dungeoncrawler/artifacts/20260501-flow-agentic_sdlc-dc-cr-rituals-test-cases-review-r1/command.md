...
- Flow source outbox: sessions/qa-dungeoncrawler/outbox/20260501-flow-agentic_sdlc-dc-cr-rituals-write-test-cases-r1.md
...
2. Review the source outbox: `sessions/qa-dungeoncrawler/outbox/20260501-flow-agentic_sdlc-dc-cr-rituals-write-test-cases-r1.md` for the completed upstream context.
