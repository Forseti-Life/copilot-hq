- command: |
    ...
    - Completed item: 20260425-syshealth-php-fatal-dungeoncrawler
    - Dev seat: dev-dungeoncrawler
    - Dev outbox: sessions/dev-dungeoncrawler/outbox/20260425-syshealth-php-fatal-dungeoncrawler.md
