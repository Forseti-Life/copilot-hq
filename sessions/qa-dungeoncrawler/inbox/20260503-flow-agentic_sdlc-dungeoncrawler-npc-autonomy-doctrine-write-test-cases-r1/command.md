...
- Flow source outbox: sessions/pm-dungeoncrawler/outbox/20260503-flow-agentic_sdlc-dungeoncrawler-npc-autonomy-doctrine-pm-scope-rebaseline-r1.md
...
2. Review the source outbox: `sessions/pm-dungeoncrawler/outbox/20260503-flow-agentic_sdlc-dungeoncrawler-npc-autonomy-doctrine-pm-scope-rebaseline-r1.md` for the completed upstream context.
...
- If `features/dungeoncrawler-npc-autonomy-doctrine/03-test-plan.md` and `qa-suites/products/dungeoncrawler/features/dungeoncrawler-npc-autonomy-doctrine.json` already exist and still match the current feature scope, fast-exit with `- Status: done` and cite those exact paths instead of regenerating them.
...
## Required artifacts
- Write or update `sessions/qa-dungeoncrawler/artifacts/dungeoncrawler-npc-autonomy-doctrine-test-plan.md` with the concrete test plan for this feature.
- Write or update `qa-suites/products/dungeoncrawler/features/dungeoncrawler-npc-autonomy-doctrine.json` with the feature-level suite overlay or equivalent QA coverage metadata.
