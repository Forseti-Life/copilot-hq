# Gate 2 follow-up: 20260412-dungeoncrawler-release-u
...
Active release `20260412-dungeoncrawler-release-u` has scoped features but no Gate 2 APPROVE artifact in `sessions/qa-dungeoncrawler/outbox`.
