...
- Flow source outbox: sessions/pm-dungeoncrawler/outbox/20260502-flow-feature_request_intake-suggestion-dungeoncrawler-nid-47-pm-scope-decision-r1.md
...
2. Review the source outbox: `sessions/pm-dungeoncrawler/outbox/20260502-flow-feature_request_intake-suggestion-dungeoncrawler-nid-47-pm-scope-decision-r1.md` for the completed upstream context.
...
- Rejected outbox: sessions/ba-dungeoncrawler/outbox/20260502-flow-feature_request_intake-suggestion-dungeoncrawler-nid-47-prepare-delivery-handoff-r1.md
- Validation retry: 1
- Prepare Delivery Handoff must include '- Feature id: <canonical-id>'
