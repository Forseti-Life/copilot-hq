...
- Status: pending
- Supervisor: board
- Created: 2026-05-05T12:03:38.085267+00:00
...
## Signals fired (3):
  - NO_DONE_OUTBOX: no agent wrote Status:done in 297m (threshold 15m)
  - BLOCKED_TICKS: 32 consecutive ticks with 10 blocked agent(s) and no resolution (threshold 5)
  - NO_RELEASE_PROGRESS: no release signoff in 227h 58m (threshold 2h)
