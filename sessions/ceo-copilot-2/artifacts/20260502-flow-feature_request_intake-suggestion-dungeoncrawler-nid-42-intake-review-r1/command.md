...
- Flow run id: suggestion-dungeoncrawler-nid-42
- Flow node: Intake Review
- Flow owner seat: ceo-copilot-2
- Flow previous node: Receive Feature Request
- Flow source outbox: sessions/ceo-copilot-2/outbox/20260502-195001-flow-feature-request-intake-dungeoncrawler-nid-42-vex-the-scout-vex_dungeon_scout-should-b.md
...
2. Review the source outbox: `sessions/ceo-copilot-2/outbox/20260502-195001-flow-feature-request-intake-dungeoncrawler-nid-42-vex-the-scout-vex_dungeon_scout-should-b.md` for the completed upstream context.
