...
- Status: pending
- Supervisor: board
- Created: 2026-05-05T03:26:09.036470+00:00
...
## Signals fired (3):
  - NO_DONE_OUTBOX: no agent wrote Status:done in 45m (threshold 15m)
  - BLOCKED_TICKS: 118 consecutive ticks with 11 blocked agent(s) and no resolution (threshold 5)
  - NO_RELEASE_PROGRESS: no release signoff in 219h 20m (threshold 2h)
...
- ceo-copilot-2: 20260505-030249-gating-agent-quarantine-escalation.md [status=blocked]
  Blockers:
