...
- Flow run id: suggestion-dungeoncrawler-nid-52
- Flow node: Intake Review
- Flow owner seat: ceo-copilot-2
- Flow previous node: Receive Feature Request
- Flow source outbox: sessions/ceo-copilot-2/outbox/20260502-235702-flow-feature-request-intake-dungeoncrawler-nid-52-on-campaign-page-reload-the-player-s-cur.md
...
2. Review the source outbox: `sessions/ceo-copilot-2/outbox/20260502-235702-flow-feature-request-intake-dungeoncrawler-nid-52-on-campaign-page-reload-the-player-s-cur.md` for the completed upstream context.
