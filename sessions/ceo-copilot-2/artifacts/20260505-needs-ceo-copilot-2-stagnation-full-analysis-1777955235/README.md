...
- Status: pending
- Supervisor: board
- Created: 2026-05-05T04:27:08.122677+00:00
...
## Signals fired (3):
  - NO_DONE_OUTBOX: no agent wrote Status:done in 106m (threshold 15m)
  - BLOCKED_TICKS: 35 consecutive ticks with 11 blocked agent(s) and no resolution (threshold 5)
  - NO_RELEASE_PROGRESS: no release signoff in 220h 21m (threshold 2h)
...
- ceo-copilot-2: 20260505-040255-gating-agent-quarantine-escalation.md [status=blocked]
  Blockers:
