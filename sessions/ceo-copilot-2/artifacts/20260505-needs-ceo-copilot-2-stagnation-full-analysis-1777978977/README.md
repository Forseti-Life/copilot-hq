...
- Status: pending
- Supervisor: board
- Created: 2026-05-05T11:02:54.462858+00:00
...
## Signals fired (3):
  - NO_DONE_OUTBOX: no agent wrote Status:done in 236m (threshold 15m)
  - BLOCKED_TICKS: 31 consecutive ticks with 10 blocked agent(s) and no resolution (threshold 5)
  - NO_RELEASE_PROGRESS: no release signoff in 226h 57m (threshold 2h)
...
- pm-dungeoncrawler: `20260505-release-kpi-stagnation` (0m old)
