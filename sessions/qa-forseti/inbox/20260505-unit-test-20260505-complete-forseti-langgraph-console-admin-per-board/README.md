...
## Scope
- QA seat: qa-forseti
- Completed dev item: 20260505-complete-forseti-langgraph-console-admin-per-board
- Dev outbox evidence: sessions/dev-forseti/outbox/20260505-complete-forseti-langgraph-console-admin-per-board.md
