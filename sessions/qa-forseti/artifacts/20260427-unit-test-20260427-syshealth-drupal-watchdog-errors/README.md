...
## Scope
- QA seat: qa-forseti
- Completed dev item: 20260427-syshealth-drupal-watchdog-errors
- Dev outbox evidence: sessions/dev-forseti/outbox/20260427-syshealth-drupal-watchdog-errors.md
