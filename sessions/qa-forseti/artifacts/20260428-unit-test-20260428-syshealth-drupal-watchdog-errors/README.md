...
## Scope
- QA seat: qa-forseti
- Completed dev item: 20260428-syshealth-drupal-watchdog-errors
- Dev outbox evidence: sessions/dev-forseti/outbox/20260428-syshealth-drupal-watchdog-errors.md
