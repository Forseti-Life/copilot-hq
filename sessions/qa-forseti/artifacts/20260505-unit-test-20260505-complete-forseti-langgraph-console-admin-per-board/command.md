- command: |
    ...
    - Completed item: 20260505-complete-forseti-langgraph-console-admin-per-board
    - Dev seat: dev-forseti
    - Dev outbox: sessions/dev-forseti/outbox/20260505-complete-forseti-langgraph-console-admin-per-board.md
