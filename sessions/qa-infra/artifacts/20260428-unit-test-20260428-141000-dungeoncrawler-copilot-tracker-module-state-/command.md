- command: |
    ...
    - Completed item: 20260428-141000-dungeoncrawler-copilot-tracker-module-state-audit
    - Dev seat: dev-infra
    - Dev outbox: sessions/dev-infra/outbox/20260428-141000-dungeoncrawler-copilot-tracker-module-state-audit.md
