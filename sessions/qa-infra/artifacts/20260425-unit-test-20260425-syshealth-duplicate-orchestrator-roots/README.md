...
## Scope
- QA seat: qa-infra
- Completed dev item: 20260425-syshealth-duplicate-orchestrator-roots
- Dev outbox evidence: sessions/dev-infra/outbox/20260425-syshealth-duplicate-orchestrator-roots.md
