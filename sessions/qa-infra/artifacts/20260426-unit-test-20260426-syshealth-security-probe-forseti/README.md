...
## Scope
- QA seat: qa-infra
- Completed dev item: 20260426-syshealth-security-probe-forseti
- Dev outbox evidence: sessions/dev-infra/outbox/20260426-syshealth-security-probe-forseti.md
