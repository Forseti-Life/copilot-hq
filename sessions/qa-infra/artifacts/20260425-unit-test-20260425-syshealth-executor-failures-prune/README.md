...
## Scope
- QA seat: qa-infra
- Completed dev item: 20260425-syshealth-executor-failures-prune
- Dev outbox evidence: sessions/dev-infra/outbox/20260425-syshealth-executor-failures-prune.md
