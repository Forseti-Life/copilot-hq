...
## Scope
- QA seat: qa-infra
- Completed dev item: 20260428-syshealth-merge-health-remediation
- Dev outbox evidence: sessions/dev-infra/outbox/20260428-syshealth-merge-health-remediation.md
