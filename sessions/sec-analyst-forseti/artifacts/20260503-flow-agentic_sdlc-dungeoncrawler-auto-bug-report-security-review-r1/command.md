...
- Flow node: Security Review
- Flow owner seat: sec-analyst-forseti
- Flow previous node: Code Review
- Flow source outbox: sessions/agent-code-review/outbox/20260503-flow-agentic_sdlc-dungeoncrawler-auto-bug-report-code-review-validation-r1.md
- Product team id: dungeoncrawler
- Product team label: Dungeoncrawler
- Flow incoming conditions: Approved
- Available flow outcomes: Approved | Changes requested

# Flow handoff: agentic_sdlc / Security Review

This inbox item was routed automatically from `Code Review` after `agent-code-review` completed the previous step.

## Required action
1. Execute the responsibilities of `Security Review` as the owning seat `sec-analyst-forseti`.
2. Review the source outbox: `sessions/agent-code-review/outbox/20260503-flow-agentic_sdlc-dungeoncrawler-auto-bug-report-code-review-validation-r1.md` for the completed upstream context.
