...
- `features/dc-cr-dwarven-weapon-expertise/feature.md` ✓
- `features/dc-cr-dwarven-weapon-expertise/01-acceptance-criteria.md` ✓
...
Added 5 QA cases covering dwarven weapon expertise, edge handling, and validation; suite validated.
...
If you want to review the test plan:
  cat features/dc-cr-dwarven-weapon-expertise/03-test-plan.md

If you want to review the runnable suite metadata:
  cat qa-suites/products/dungeoncrawler/features/dc-cr-dwarven-weapon-expertise.json
