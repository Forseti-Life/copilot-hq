...
- **Next release** — You groom the backlog so Stage 0 of 20260412-dungeoncrawler-release-ac is instant scope selection.
...
For each feature selected into 20260412-dungeoncrawler-release-ac:
```bash
...
Anything not groomed when Stage 0 of 20260412-dungeoncrawler-release-ac starts is automatically deferred.
