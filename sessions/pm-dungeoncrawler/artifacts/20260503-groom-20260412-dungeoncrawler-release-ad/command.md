- Status: done
- Completed: 2026-05-03T21:21:44Z

# Groom Next Release: 20260412-dungeoncrawler-release-ad

- Site: dungeoncrawler
- Current release (Dev executing): 20260412-dungeoncrawler-release-ac
- Next release (your target): 20260412-dungeoncrawler-release-ad
...
- **Next release** — You groom the backlog so Stage 0 of 20260412-dungeoncrawler-release-ad is instant scope selection.

This task does NOT touch the current release. All work here is for 20260412-dungeoncrawler-release-ad only.
...
For each feature selected into 20260412-dungeoncrawler-release-ad:
```bash
...
Anything not groomed when Stage 0 of 20260412-dungeoncrawler-release-ad starts is automatically deferred.
