...
- Rejected outbox: sessions/agent-code-review/outbox/20260503-flow-agentic_sdlc-dungeoncrawler-auto-bug-report-code-review-r1.md
- Validation retry: 1
- review outbox must cite at least one reviewed artifact path from the handoff
