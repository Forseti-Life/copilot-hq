...
- Flow source outbox: sessions/dev-dungeoncrawler/outbox/20260503-132627-impl-dc-gm-auto-bug-report.md
...
2. Review the source outbox: `sessions/dev-dungeoncrawler/outbox/20260503-132627-impl-dc-gm-auto-bug-report.md` for the completed upstream context.
...
- If `sessions/dev-dungeoncrawler/outbox/20260503-132627-impl-dc-gm-auto-bug-report.md` omits the exact implementation commit hash, changed-file context, or verification needed to understand the diff, finish with `- Status: done` and `- Flow outcome: Changes requested`; do not guess or drift into `needs-info`.
...
## Required artifacts
- Review the upstream implementation handoff: `sessions/dev-dungeoncrawler/outbox/20260503-132627-impl-dc-gm-auto-bug-report.md`.
- Review the approved feature brief: `features/dc-gm-auto-bug-report/feature.md`.
- Review the acceptance criteria: `features/dc-gm-auto-bug-report/01-acceptance-criteria.md`.
- Review the test plan when present: `features/dc-gm-auto-bug-report/03-test-plan.md`.
