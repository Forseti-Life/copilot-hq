...
- Flow source outbox: sessions/dev-dungeoncrawler/outbox/20260503-flow-agentic_sdlc-dungeoncrawler-npc-dialogue-fix-nid-38-generate-code-r2.md
...
2. Review the source outbox: `sessions/dev-dungeoncrawler/outbox/20260503-flow-agentic_sdlc-dungeoncrawler-npc-dialogue-fix-nid-38-generate-code-r2.md` for the completed upstream context.
...
- If `sessions/dev-dungeoncrawler/outbox/20260503-flow-agentic_sdlc-dungeoncrawler-npc-dialogue-fix-nid-38-generate-code-r2.md` omits the exact implementation commit hash, changed-file context, or verification needed to understand the diff, finish with `- Status: done` and `- Flow outcome: Changes requested`; do not guess or drift into `needs-info`.
...
## Required artifacts
- Review the upstream implementation handoff: `sessions/dev-dungeoncrawler/outbox/20260503-flow-agentic_sdlc-dungeoncrawler-npc-dialogue-fix-nid-38-generate-code-r2.md`.
- Review the approved feature brief: `features/dungeoncrawler-npc-dialogue-fix-nid-38/feature.md`.
- Review the acceptance criteria: `features/dungeoncrawler-npc-dialogue-fix-nid-38/01-acceptance-criteria.md`.
- Review the test plan when present: `features/dungeoncrawler-npc-dialogue-fix-nid-38/03-test-plan.md`.
