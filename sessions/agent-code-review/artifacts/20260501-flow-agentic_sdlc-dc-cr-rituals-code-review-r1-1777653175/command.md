...
- Flow source outbox: sessions/dev-dungeoncrawler/outbox/20260501-161909-impl-dc-cr-rituals.md
...
2. Review the source outbox: `sessions/dev-dungeoncrawler/outbox/20260501-161909-impl-dc-cr-rituals.md` for the completed upstream context.
...
- If `sessions/dev-dungeoncrawler/outbox/20260501-161909-impl-dc-cr-rituals.md` omits the exact implementation commit hash, changed-file context, or verification needed to understand the diff, finish with `- Status: done` and `- Flow outcome: Changes requested`; do not guess or drift into `needs-info`.
...
## Required artifacts
- Review the upstream implementation handoff: `sessions/dev-dungeoncrawler/outbox/20260501-161909-impl-dc-cr-rituals.md`.
- Review the approved feature brief: `features/dc-cr-rituals/feature.md`.
- Review the acceptance criteria: `features/dc-cr-rituals/01-acceptance-criteria.md`.
- Review the test plan when present: `features/dc-cr-rituals/03-test-plan.md`.
