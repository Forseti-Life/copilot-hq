...
- Flow source outbox: sessions/dev-dungeoncrawler/outbox/20260503-132627-impl-dungeoncrawler-auto-bug-reporting.md
...
2. Review the source outbox: `sessions/dev-dungeoncrawler/outbox/20260503-132627-impl-dungeoncrawler-auto-bug-reporting.md` for the completed upstream context.
...
## Required artifacts
- Review the upstream implementation handoff: `sessions/dev-dungeoncrawler/outbox/20260503-132627-impl-dungeoncrawler-auto-bug-reporting.md`.
- Review the approved feature brief: `features/dungeoncrawler-auto-bug-reporting/feature.md`.
- Review the acceptance criteria: `features/dungeoncrawler-auto-bug-reporting/01-acceptance-criteria.md`.
- Review the test plan when present: `features/dungeoncrawler-auto-bug-reporting/03-test-plan.md`.
